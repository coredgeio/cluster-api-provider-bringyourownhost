...
1. Download the [byoh-hostagent-linux-amd64](https://github.com/coredgeio/cluster-api-provider-bringyourownhost/releases/download/v0.3.0/byoh-hostagent-linux-amd64)
